...
public class Send_email extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_mail:
                Intent mail = new Intent(Send_email.this, Send_email.class);
                startActivity(mail);
                break;
            case R.id.nav_poll:
                Intent poll = new Intent(Send_email.this, Poll.class);
                startActivity(poll);
                break;
            case R.id.nav_bar:
                Intent bar = new Intent(Send_email.this, Bar.class);
                startActivity(bar);
                break;
            case R.id.nav_list:
            ...
            case R.id.nav_internal_schedule:
                Intent internal_schedule = new Intent(Send_email.this, Internal_schedule.class);
